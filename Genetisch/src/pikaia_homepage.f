...
c     Now call pikaia
      call pikaia(prob2,n,ctrl,x,f,status)
...
c*********************************************************************
      function prob2(n,x)
c=====================================================================
c     Compute sample fitness function (2 Gauss functions)
c=====================================================================
      implicit none
c
c     Input:
...
c
      ...
      r1=(0.5-x(1))**2+ (0.5-x(2))**2
      r2=(0.6-x(1))**2+ (0.1-x(2))**2
      prob2 = 0.8/exp(r1/0.09) + 0.879008/exp(r2/0.03**2)
